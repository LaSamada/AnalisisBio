...
%Model parameters
Yxs =p(3) ; Ylips = 0.272; Ycits = 0.89; 
gamma = 0.06; mumax = p(1); rhonmax =p(6) ; Q0 =p(7) ; Ks1 = p(4); kl1 = 83.64 ; Kn =p(5) ; pilipmax = 0.039; Ks2 =  1.482; kl2 = 44.7 ;
alfa = 0.36; k2 = 9.75 ; qncrit = 0.047; picitmax = p(2); Ks3 = 12.22 ; kl3 = 40.11 ; k3 = 37.63;
